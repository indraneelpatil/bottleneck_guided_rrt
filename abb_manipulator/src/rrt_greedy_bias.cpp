...
while(ros::ok()&& goal_search)
{
      ...
      //*************GREEDY EXTEND FUNCTION**************************
      
      if(goal_rand==false)
      {
            std::cout<<"Normal Extend"<<std::endl;
...
//if(found==true)
          ...
          else
          {
                while(greedy_search)
                {
                    std::cout<<"Greedy Extend started"<<std::endl;
                  //Check if within limits of max travel distance
...
//if(found==true)
                          ...
                          if(!collision_result)
                        {     
                              std::cout<<"Extension is safe"<<std::endl;
                              V.push_back(point_new);
                              p.x=point_new[0]; 
                              p.y=point_new[1]; 
                              p.z=point_new[2];
                          ...
                          {
                            greedy_search=false;
                            std::cout<<"Collision detected exiting Greedy loop"<<std::endl;
                          }
                      //std::cout<<"Hey"<<std::endl;
                      
                      point_nearest.clear();
                      point_nearest=point_new;
                      point_new.clear();
